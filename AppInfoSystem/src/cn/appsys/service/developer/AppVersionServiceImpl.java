...
public class AppVersionServiceImpl implements AppVersionService {
	...
	@Override
	public boolean deleteVersionByAppId(Integer appId) throws Exception {
		boolean flag = false;
		if(mapper.deleteVersionByAppId(appId) > 0){
			flag = true;
		}
		return flag;
	}
	@Override
	public int getVersionCountByAppId(Integer appId) throws Exception {
		
		return mapper.getVersionCountByAppId(appId);
	}
}
